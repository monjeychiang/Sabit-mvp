...
const AssetManagementPage = () => {
    ...
    try {
      ...
      setTimeout(() => {
        const mockPortfolios = [
          { id: 1, name: "主要投資組合", description: "長期持有的加密貨幣資產" },
  ...
  const fetchAssets = async (portfolioId) => {
    ...
    try {
      ...
      setTimeout(() => {
        const mockAssets = [
          { id: 1, symbol: "BTC", name: "Bitcoin", amount: 0.5, currentValue: 25000, costBasis: 22000, changePercent: 13.64 },
          { id: 2, symbol: "ETH", name: "Ethereum", amount: 5, currentValue: 9000, costBasis: 10000, changePercent: -10 },
          { id: 3, symbol: "USDT", name: "Tether", amount: 10000, currentValue: 10000, costBasis: 10000, changePercent: 0 },
          { id: 4, symbol: "BNB", name: "Binance Coin", amount: 10, currentValue: 3000, costBasis: 2500, changePercent: 20 },
          { id: 5, symbol: "SOL", name: "Solana", amount: 50, currentValue: 5000, costBasis: 4000, changePercent: 25 }
        ];
        setAssets(mockAssets);
        
        // 計算總資產價值和變化
        const totalValue = mockAssets.reduce((sum, asset) => sum + asset.currentValue, 0);
        const totalCost = mockAssets.reduce((sum, asset) => sum + asset.costBasis, 0);
        ...
        <div className="flex space-x-4 overflow-x-auto pb-2">
          ...
          >
            <CardContent className="p-4 text-center">
              ...
              <span className="text-sm text-muted-foreground">新增資產組合</span>
            </CardContent>
          </Card>
        </div>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-1">
                ...
                <h3 className={`text-2xl font-bold ${
                  assetSummary.dailyChange >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
              ...
              <div className="space-y-1">
                ...
                <h3 className={`text-2xl font-bold ${
                  assetSummary.percentChange >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
